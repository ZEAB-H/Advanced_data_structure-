// writing a java program for implementing power_of_two_max_

// Main class
public class power_of_two_max_heap {
	private int[] Heap;
	private int size;
	private int maxsize;
	...
	// capacity
	public power_of_two_max_heap(int maxsize)
	{
	...
	public static void main(String[] arg)
	{
		...
		power_of_two_max_heap maxHeap = new power_of_two_max_heap(15);
